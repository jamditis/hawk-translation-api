#!/bin/bash
# Deploy docs to GitHub Pages (auto-deploys from docs/ on master push)
# GitHub Pages URL: https://jamditis.github.io/hawk-translation-api/
#
# When hawknewsservice.org hosting is ready (waiting on Marty / Cloudflare SSL fix),
# uncomment the SFTP block below and replace this push-only deploy.
set -e

git push origin master
echo "Docs deployed via GitHub Pages."

# ── hawknewsservice.org SFTP deploy (disabled until Marty fixes Cloudflare SSL) ──────────
